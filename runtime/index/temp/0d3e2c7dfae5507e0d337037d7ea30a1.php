<?php /*a:1:{s:56:"D:\phpstudy_pro\WWW\chat\app\index\view\index\index.html";i:1602858226;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="utf-8">
...
<script type="text/javascript">
    ...
    layui.use('layim', function(layim){
        ...
        // });
        var uinfo = {
            id:  "<?php echo htmlentities($visiter); ?>",
            username: '游客' + "<?php echo htmlentities($visiter); ?>",
        ...
        socket.onopen = function(){
            ...
            var login_data = '{"type":"user_init", "user_id":"'+uinfo.id+'", "name" : "'+uinfo.username+'", "avatar" : "'+uinfo.avatar+'", "group": '+uinfo.group+'}';
