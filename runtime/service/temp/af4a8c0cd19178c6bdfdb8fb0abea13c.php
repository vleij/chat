<?php /*a:5:{s:58:"D:\phpstudy_pro\WWW\chat\app\service\view\index\index.html";i:1601906358;s:61:"D:\phpstudy_pro\WWW\chat\app\service\view\public\profile.html";i:1601892518;s:59:"D:\phpstudy_pro\WWW\chat\app\service\view\public\group.html";i:1601892075;s:62:"D:\phpstudy_pro\WWW\chat\app\service\view\public\contacts.html";i:1601892126;s:62:"D:\phpstudy_pro\WWW\chat\app\service\view\public\settings.html";i:1601891724;}*/ ?>
<!doctype html>
<html lang="en">
...
<div class="layout-wrapper d-lg-flex">
    ...
    <div class="text-center p-4 border-bottom">
        ...
        <h5 class="font-size-16 mb-1 text-truncate"><?php echo htmlentities($serviceUser['user_name']); ?></h5>
        <p class="text-muted text-truncate mb-1"><i class="ri-record-circle-fill font-size-10 text-success mr-1 d-inline-block"></i> 在线</p>
    </div>
    <!-- End profile user -->
    ...
    <div class="p-4 user-profile-desc" data-simplebar>
        <div class="text-muted">
            <p class="mb-4"><?php echo htmlentities($serviceUser['introduce']); ?></p>
        </div>
            ...
            <div class="card shadow-none border mb-2">
                ...
                <div id="profile-user-collapseOne" class="collapse show"
                    ...
                    <div class="card-body">
                        ...
                        <div>
                            <p class="text-muted mb-1">名称</p>
                            <h5 class="font-size-14"><?php echo htmlentities($serviceUser['user_name']); ?></h5>
                        </div>

                        <div class="mt-4">
                            <p class="text-muted mb-1">邮箱</p>
                            <h5 class="font-size-14"><?php echo htmlentities($serviceUser['email']); ?></h5>
                        </div>

                        <div class="mt-4">
                            <p class="text-muted mb-1">时间</p>
                            <h5 class="font-size-14"><?php echo htmlentities(date('H:i',!is_numeric($serviceUser['last_login_time'])? strtotime($serviceUser['last_login_time']) : $serviceUser['last_login_time'])); ?> AM</h5>
                        </div>

                        <div class="mt-4">
                            <p class="text-muted mb-1">IP地址</p>
                            <h5 class="font-size-14 mb-0"><?php echo htmlentities($serviceUser['last_login_ip']); ?></h5>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <a href="#profile-user-collapseTwo" class="text-dark collapsed" data-toggle="collapse"
                   ...
                   aria-controls="profile-user-collapseTwo">
                    <div class="card-header" id="profile-user-headingTwo">
                        <h5 class="font-size-14 m-0">
                            <i class="ri-attachment-line mr-2 align-middle d-inline-block"></i> 附加文件
                            <i class="mdi mdi-chevron-up float-right accor-plus-icon"></i>
                        </h5>
                    </div>
                </a>
                ...
                <div>
                    <div class="px-4 pt-4">
                        ...
                        <div class="search-box chat-search-box">
                            <div class="input-group mb-3 bg-light  input-group-lg rounded-lg">
                                ...
                                <input type="text" class="form-control bg-light" placeholder="搜索消息或者用户">
                            </div>
                        </div> <!-- Search Box-->
                    </div> <!-- .p-4 -->
                    ...
                    <div class="px-4 pb-4" dir="ltr">
                        ...
                        <div class="owl-carousel owl-theme" id="user-status-carousel">
                            ...
                            <div class="item">
                                <a href="#" class="user-status-box">
                                    <div class="avatar-xs mx-auto d-block chat-user-img online">
                                        <img src="/static/assets/images/users/avatar-4.jpg" alt="user-img" class="img-fluid rounded-circle">
                                        <span class="user-status"></span>
                                    </div>
                            ...
                            <div class="item">
                                <a href="#" class="user-status-box">
                                    <div class="avatar-xs mx-auto d-block chat-user-img online">
                                        <img src="/static/assets/images/users/avatar-5.jpg" alt="user-img" class="img-fluid rounded-circle">
                                        <span class="user-status"></span>
                                    </div>
                            ...
                            <div class="item">
                                <a href="#" class="user-status-box">
                                    <div class="avatar-xs mx-auto d-block chat-user-img online">
                                        <img src="/static/assets/images/users/avatar-6.jpg" alt="user-img" class="img-fluid rounded-circle">
                                        <span class="user-status"></span>
                                    </div>
                    ...
                    <div class="px-2">
                        ...
                        <div class="chat-message-list" data-simplebar>
                            ...
                            <ul class="list-unstyled chat-list chat-user-list" role="tablist">
                                <?php if(is_array($user_list) || $user_list instanceof \think\Collection || $user_list instanceof \think\Paginator): $i = 0; $__LIST__ = $user_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
                                <li class='user_active id="u-<?php echo htmlentities($v['id']); ?>" <?php if($i == '1'): ?> active <?php endif; ?>' data-id="<?php echo htmlentities($v['id']); ?>" data-avatar="<?php echo htmlentities($v['user_avatar']); ?>" data-name="<?php echo htmlentities($v['user_name']); ?>" role="presentation">
                                    <a href="#uchat-<?php echo htmlentities($v['id']); ?>" aria-controls="uchat-<?php echo htmlentities($v['id']); ?>" role="tab" data-toggle="tab" data-name="<?php echo htmlentities($v['user_name']); ?>" data-id="<?php echo htmlentities($v['id']); ?>">
                                        <div class="media">
                                            <?php if(empty($v['user_avatar'])): ?>
                                            <div class="chat-user-img align-self-center mr-3">
                                                <div class="avatar-xs">
                                                            <span class="avatar-title rounded-circle bg-soft-primary text-primary">
                                                                <?php echo htmlentities(substr($v['user_name'],0,3)); ?>
                                                            </span>
                                                </div>
                                            </div>
                                            <?php else: ?>
                                            <div class="chat-user-img online align-self-center mr-3">
                                                <img src="<?php echo htmlentities($v['user_avatar']); ?>" class="rounded-circle avatar-xs" alt="">
                                                <span class="user-status"></span>
                                            </div>
                                            <?php endif; ?>

                                            <div class="media-body overflow-hidden">
                                                <h5 class="text-truncate font-size-15 mb-1"><?php echo htmlentities($v['user_name']); ?></h5>
                                                <p class="chat-user-message text-truncate mb-0"><?php echo htmlentities($v['content']); ?></p>
                                            </div>
                                            <div class="font-size-11"><?php echo htmlentities($v['last_msg_time']); ?> min</div>
                                        </div>
                                    </a>
                                </li>
    ...
    <div class="user-chat w-100">
        <div class="d-lg-flex">
                ...
                <div class="p-3 p-lg-4 border-bottom">
                    <div class="row align-items-center">
                        <div class="col-sm-4 col-8">
                            <div class="media align-items-center">
                                <?php if(!(empty($user_list[0]) || (($user_list[0] instanceof \think\Collection || $user_list[0] instanceof \think\Paginator ) && $user_list[0]->isEmpty()))): ?>
                                <div class="d-block d-lg-none mr-2">
                                    <a href="javascript: void(0);" class="user-chat-remove text-muted font-size-16 p-2"><i class="ri-arrow-left-s-line"></i></a>
                                </div>
                                <?php if(empty($user_list[0]['user_avatar'])): ?>
                                <div class="mr-3">
                                    <div class="avatar-xs">
                                        <span class="avatar-title rounded-circle bg-soft-primary text-primary">
                                            <?php echo htmlentities(substr($user_list[0]['user_name'],0,3)); ?>
                                        </span>
                                    </div>
                                </div>
                                <?php else: ?>
                                <div class="mr-3">
                                    <img src="<?php echo htmlentities($user_list[0]['user_avatar']); ?>" class="rounded-circle avatar-xs" alt="">
                                    <span class="user-status"></span>
                                </div>
                                <?php endif; ?>

                                <div class="media-body overflow-hidden">
                                    <h5 class="font-size-16 mb-0 text-truncate"><a href="#" class="text-reset user-profile-show" id="user_name"><?php echo htmlentities($user_list[0]['user_name']); ?></a> <i class="ri-record-circle-fill font-size-10 text-success d-inline-block ml-1"></i></h5>
                                </div>
                            </div>
                            <?php endif; ?>
                        </div>
            ...
            <div class="tab-content" id="chat-main">
                <?php if(is_array($user_list) || $user_list instanceof \think\Collection || $user_list instanceof \think\Paginator): $i = 0; $__LIST__ = $user_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
                <div class='chat-conversation p-3 p-lg-4 tab-pane fade <?php if($i == '1'): ?>in active show<?php endif; ?> chat-box' data-simplebar="init" role="tabpanel"  id="uchat-<?php echo htmlentities($v['id']); ?>">
                    <ul class="list-unstyled mb-0 " id="chatMessage-<?php echo htmlentities($v['id']); ?>">
                ...
                <div class="p-3 p-lg-4 border-top mb-0">
                    <div class="row no-gutters">
                        <div class="col">
                            <div>
                                <input type="text" class="form-control form-control-lg bg-light border-light msg-area" placeholder="输入消息...">
                            </div>
                        </div>
                        <div class="col-auto">
                            <div class="chat-input-links ml-md-2">
                                <ul class="list-inline mb-0">
                                    ...
                                    <li class="list-inline-item">
                                        <button type="submit" class="btn btn-primary font-size-16 btn-lg chat-send waves-effect waves-light send">
            ...
            <div class="user-profile-sidebar">
                ...
                <div class="text-center p-4 border-bottom">
                    ...
                    <p class="text-muted text-truncate mb-1"><i class="ri-record-circle-fill font-size-10 text-success mr-1"></i> 在线</p>
                </div>
                <!-- End profile user -->
...
<script>
    ...
    var service_id = "<?php echo htmlentities($serviceUser['id']); ?>";
    var uname = "<?php echo htmlentities($serviceUser['user_name']); ?>";
    var avatar = "/static/service/images/tx.jpg";
    var group = "1";
    var socket_server = "127.0.0.1:8282";
</script>
<script src="/static/service/js/servicechat.js"></script>
<script>
    checkUser(1)
</script>
</body>
